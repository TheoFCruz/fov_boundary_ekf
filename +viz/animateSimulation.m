...
handles.RawBoundary = patch(worldAxes, nan, nan, [0.20, 0.55, 0.90], ...
    ...
    'DisplayName', 'Oracle sampled boundary');
handles.MeasurementBoundary = plot(worldAxes, nan, nan, '-', ...
    'Color', [0.55, 0.20, 0.70], 'LineWidth', 1.2, ...
    'DisplayName', 'Measurement boundary');
...
handles.ScanLine = plot(boundaryAxes, nan, nan, '-.', 'Color', [0.55, 0.20, 0.70], ...
    'DisplayName', 'Measurement range');
